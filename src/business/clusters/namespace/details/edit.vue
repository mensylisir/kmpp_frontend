...
import {
  updateNamespace,
  getNamespaceItem,
} from "@/api/cluster/namespace-details";
  ...
  methods: {
    submitForm() {
      ...
      const reBody = {
        ...
        resource_name: this.namespaceInfo.metadata.name,
        namespace: this.namespaceInfo.metadata.namespace,
        data: value,
      };
      this.updateNamespaceItem(reBody);
      //
    },
    resetForm() {
      this.$router.push({
    ...
    async updateNamespaceItem(data) {
