      ...
      <el-col :span="10">
        <div class="grid-content bg-purple-light">
          ...
          >
            ...
            <el-form-item
              v-if="credentialType === 'exists'"
              :label="$t('host.credential_name')"
              prop="credentialId"
            >
              <el-select
                style="width: 100%"
            ...
            <span v-if="credentialType === 'new'">
              ...
              <el-form-item
                :label="$t('host.credential_type')"
                prop="credential.type"
                required
              >
                <el-radio-group v-model="form.credential.type">
                  ...
                  <el-radio label="privateKey">{{
                    $t("credential.privateKey")
                  }}</el-radio>
                </el-radio-group>
              </el-form-item>
              <el-form-item
                v-if="form.credential.type === 'password'"
                :label="$t('credential.password')"
                prop="credential.password"
              >
                <el-input
                  type="password"
              ...
              <el-form-item
                v-if="form.credential.type === 'privateKey'"
                :label="$t('credential.privateKey')"
                prop="credential.privateKey"
              >
                <el-input
                  type="textarea"
                  v-model="form.credential.privateKey"
                  clearable
                ></el-input>
              </el-form-item>
            </span>
...
import { createVolume } from "@/api/hosts";
