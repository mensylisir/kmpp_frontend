  ...
  <el-dropdown trigger="click" @command="handleCommand">
    <span class="el-dropdown-link">
      <i
        ...
        style="color: #5b5d78; margin-right: 3px"
      ></i>
      <span>{{ name }}</span>
    ...
    <el-dropdown-menu slot="dropdown">
      <div class="personalDropdown">
        ...
        <el-dropdown-item
          class="iconfont icontuichudenglu"
    ...
    >
      ...
      >
        <el-form-item
          style="width: 100%"
          :label="$t('commons.personal.original_password')"
          required
        >
    ...
    >
      <div class="aboutBackground" style="padding: 20px 25px">
        <img
          style="margin-left: 0"
          :src="require('@/assets/KubeOperator-red.png')"
          class="sidebar-logo"
          alt="Sidebar Logo"
        />
        <p style="color: #242e42">
          {{ $t("commons.personal.ko_introduction") }}
        </p>
      ...
      <div style="padding: 15px 20px; box-shadow: 0px -10px 8px -5px #f0f1f2">
        <el-row style="font-size: 6px; color: #242e42; text-align: center">
          <el-col :span="6">
            <el-link @click="toGithub" class="iconfont iconhuaban88"
              ><span>{{ $t("commons.personal.project_url") }}</span></el-link
            >
          </el-col>
          <el-col :span="6">
            <el-link @click="toIssue" class="iconfont iconbug">{{
              $t("commons.personal.issue")
            }}</el-link>
          </el-col>
          <el-col :span="6">
            <el-link @click="toTalk" class="iconfont icontaolun">{{
              $t("commons.personal.talk")
            }}</el-link>
          </el-col>
          <el-col :span="6">
            <el-link @click="toGithubStar" class="iconfont iconStarStar">{{
              $t("commons.personal.star")
            }}</el-link>
          </el-col>
        </el-row>
      </div>
...
export default {
  ...
  methods: {
    ...
    toIssue() {
      window.open(
        "https://github.com/KubeOperator/KubeOperator/issues",
        "_blank"
      );
    },
    toTalk() {
    ...
    checkPassword(rule, value, callback) {
      if (this.form.password !== this.confirmPassword) {
        return callback(
          new Error(this.$t("commons.personal.confirm_password1_info"))
        );
      }
      callback();
    },
